package com.newframe.core.dao.jdbc;
...
public class SimpleJdbcTemplate {
	...
	public SimpleJdbcTemplate(DataSource dataSource) {
		// jdbcTemplate=new
		// org.springframework.jdbc.core.simple.SimpleJdbcTemplate(dataSource);
	 ...
	 * 根据sql语句，返回对象集合
	 * 
	 * @param sql语句(参数用冒号加参数名，例如select
	 *            * from tb where id=:id)
	 * @param clazz类型
	 ...
	 * Assert.hasText(sql,"sql语句不正确!"); if(bean!=null){ return
	 * jdbcTemplate.update(sql, paramBeanMapper(bean)); }else{ return
